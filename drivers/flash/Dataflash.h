...
#define DATAFLASH_PAGE_SIZE_BYTES           (256)
...
#define DATAFLASH_IS_IC_VALID(x)          ((x) >= 0 && (x) < DATAFLASH_NUM_IC)

#define DATAFLASH_IS_PAGE_VALID(x)        ((x) >= 0 && (x) < DATAFLASH_NUM_PAGES)

#define DATAFLASH_IS_SECTOR_VALID(x)      ((x) >= 0 && (x) < DATAFLASH_NUM_SECTORS)

#define DATAFLASH_IS_SUBSECTOR_VALID(x)   ((x) >= 0 && (x) < DATAFLASH_NUM_SUBSECTORS)
